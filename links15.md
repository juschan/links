...
- [Why I Became A Death Doula | Alua Arthur - video](https://www.youtube.com/watch?v=f2VhPGmQ35g)
...
- [5 Fundamentals of Leadership - Leadership Development | Simon Sinek - Video](https://www.youtube.com/watch?v=BjZXRs6fAkA)
...
- [Intro to actuarial pricing - conference notes](https://www.actuaries.org/IAA/Documents/IAAHS/Singapore/PrimeReAcademy_SEM_HealthPricing_v7.pdf)
- [Insurance GLM in R](https://actuary.rbind.io/post/glm-r/)
** - [Trimming the Fat from glm() Models in R - Memory issues!!](https://win-vector.com/2014/05/30/trimming-the-fat-from-glm-models-in-r/)
...
- [How To Install nasm on Ubuntu 20.04](https://installati.one/install-nasm-ubuntu-20-04/)
- [Intro to NASM programming](http://courses.ics.hawaii.edu/ReviewICS312/morea/FirstProgram/ics312_nasm_first_program.pdf)
- [NASM Tutorial](https://cs.lmu.edu/~ray/notes/nasmtutorial/)
- [C Program to Display the current Date and Time](https://www.studytonight.com/c/programs/misc/display-current-date-and-time)
- [Bitwise Operations](https://www.cs.uaf.edu/2015/fall/cs301/lecture/10_05_bitwise.html)
- [Using Inline Assembly in C/C++](https://www.codeproject.com/Articles/15971/Using-Inline-Assembly-in-C-C)
- [C Program To Display characters from A-Z using Loops](https://www.studytonight.com/c-programs/c-program-to-display-characters-from-az-using-loops)
- [Python Runtime vs C Runtime](https://stackoverflow.com/questions/52774805/python-runtime-vs-c-runtime)
- [Data Types in C](https://intellipaat.com/blog/tutorial/c-tutorial/c-data-types/#no2)
- [How To Compiling C Program And Creating Executable File Under a Linux / UNIX / *BSD](https://www.cyberciti.biz/faq/compiling-c-program-and-creating-executable-file/)
- [How to Install Ubuntu 22.04 on VirtualBox](https://linuxhint.com/install-ubuntu22-04-virtual-box/)
